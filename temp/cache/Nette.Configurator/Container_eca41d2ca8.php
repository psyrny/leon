<?php
// source: E:\xampp\htdocs\leon\app/config/config.neon 
// source: E:\xampp\htdocs\leon\app/config/config.local.neon 

class Container_eca41d2ca8 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'Nette\Security\IAuthenticator' => array(1 => array('25_App_Model_UserManager')),
			'App\Model\UserManager' => array(1 => array('25_App_Model_UserManager')),
			'App\Model\Users' => array(1 => array('users')),
			'App\Model\ConfigParameter' => array(1 => array('configParameter')),
			'App\AdminModule\Presenters\BasePresenter' => array(array('application.1')),
			...
			'App\AdminModule\Presenters\AdminPresenter' => array(array('application.1')),
			'App\Presenters\DashboardPresenter' => array(array('application.2')),
		...
		'services' => array(
			...
			'configParameter' => 'App\Model\ConfigParameter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'E:\xampp\htdocs\leon\app',
			'wwwDir' => 'E:\xampp\htdocs\leon\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'E:\xampp\htdocs\leon\app/../temp',
	...
	public function createServiceApplication__1()
	{
		...
		$service->configParameter = $this->getService('configParameter');
		$service->users = $this->getService('users');
	...
	/**
	 * @return App\Presenters\DashboardPresenter
	 */
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'E:\xampp\htdocs\leon\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('E:\xampp\htdocs\leon\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('E:\xampp\htdocs\leon\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}


	/**
	 * @return App\Model\ConfigParameter
	 */
	public function createServiceConfigParameter()
	{
		$service = new App\Model\ConfigParameter(array(
			'projectName' => 'LEON',
			'version' => '1.0',
		));
		return $service;
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=nettehello', 'root', NULL, array('lazy' => TRUE));
	...
	{
		return new Container_eca41d2ca8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('E:\xampp\htdocs\leon\app/../temp/cache/latte');
	...
	{
		$service = new App\Model\Users($this->getService('database.default.context'));
		return $service;
	}
...
final class Container_eca41d2ca8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_eca41d2ca8 $container)
	{
